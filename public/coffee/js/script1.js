...
// console.log(nav_li);
  ...
  nav_li[0].addEventListener('click',change2());
  nav_li[1].addEventListener('click',change2());
  nav_li[2].addEventListener('click',change2());
  nav_li[3].addEventListener('click',change2());
...
//   }
//
// document.getElementById('logoimg2').src = image;
// } //ends function here
